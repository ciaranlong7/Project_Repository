        ...
        if w == 0 and r == 0: #Good W2 if true
            ...
            if SDSS_min < 3000 and SDSS_max > 3920 and DESI_min < 3000 and DESI_max > 3920:
                ...
                if np.median(sdss_blue_flux_interp) > np.median(desi_blue_flux_smooth): #want turned-on minus turned-off if a CLAGN
                    ...
                    UV_NFD = [flux/norm_factor for flux in flux_change]
                else:
                ...
                mean_UV_NFD.append(np.mean(UV_NFD))
                mean_UV_NFD_unc.append(np.std(UV_NFD))
            else:
                mean_UV_NFD.append(np.nan)
                mean_UV_NFD_unc.append(np.nan)
...
quantifying_change_data = {
    ...
    "Mean UV Flux Change DESI - SDSS": mean_UV_NFD, #21
    "Mean UV Flux Change DESI - SDSS Unc": mean_UV_NFD_unc, #22
