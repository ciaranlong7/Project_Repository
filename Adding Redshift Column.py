...
CLAGN_redshifts_original = Guo_table4.iloc[:, 3].tolist()
...
CLAGN_redshifts_median = np.median(CLAGN_redshifts)
...
#Sample 1
combined_redshifts = CLAGN_redshifts+AGN_sample_one_redshifts
...
plt.hist(CLAGN_redshifts, bins=bins_flux_diff, color='red', edgecolor='black', label=f'CLAGN')
...
#Sample 2
combined_redshifts = CLAGN_redshifts+AGN_sample_two_redshifts
flux_diff_binsize = (max(combined_redshifts)-min(combined_redshifts))/50 #50 bins
bins_flux_diff = np.arange(min(combined_redshifts), max(combined_redshifts) + flux_diff_binsize, flux_diff_binsize)
plt.figure(figsize=(12,7))
...
#Sample 3
combined_redshifts = CLAGN_redshifts+AGN_sample_three_redshifts
flux_diff_binsize = (max(combined_redshifts)-min(combined_redshifts))/50 #50 bins
bins_flux_diff = np.arange(min(combined_redshifts), max(combined_redshifts) + flux_diff_binsize, flux_diff_binsize)
plt.figure(figsize=(12,7))
...
axes[0].hist(CLAGN_redshifts, bins=bins_flux_diff, color='red', edgecolor='black', label=f'CLAGN')
...
axes[1].hist(CLAGN_redshifts, bins=bins_flux_diff, color='red', edgecolor='black', label=f'CLAGN')
...
axes[2].hist(CLAGN_redshifts, bins=bins_flux_diff, color='red', edgecolor='black', label=f'CLAGN')
